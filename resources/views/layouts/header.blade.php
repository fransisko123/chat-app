            ...
            <li class="dropdown pc-h-item">
              ...
              <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                <a
                  ...
                  ><i class="ph-duotone ph-moon"></i> <span>Dark</span> </a
                ><a
                  href="#!"
                  class="dropdown-item"
                  onclick="layout_change('light')"
                  ><i class="ph-duotone ph-sun-dim"></i> <span>Light</span> </a
                ><a
                  href="#!"
                  class="dropdown-item"
                  onclick="layout_change_default()"
                  ><i class="ph-duotone ph-cpu"></i> <span>Default</span></a
                >
              </div>
            </li>
            <li class="dropdown pc-h-item">
              ...
              <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                ...
                ><a href="#!" class="dropdown-item"
                  ><i class="ph-duotone ph-power"></i> <span>Logout</span></a
                >
              </div>
            </li>
            <li class="dropdown pc-h-item">
              <a
                ...
                <span class="badge bg-danger pc-h-badge">3</span></a
              >
              <div
                    ...
                    <li class="list-group-item">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div class="d-flex">
                            <div class="flex-grow-1 me-3 position-relative">
                              <h5 class="mb-0 text-truncate">
                                Keefe Bond
                                <span class="text-body">added new tags to </span
                                >💪 Design system
                              </h5>
                            </div>
                            <div class="flex-shrink-0">
                          ...
                          <span
                            class="badge bg-light-primary border border-primary me-1 mt-1"
                            >web design</span
                          >
                          <span
                            class="badge bg-light-warning border border-warning me-1 mt-1"
                            >Dashobard</span
                          >
                          <span
                            class="badge bg-light-success border border-success me-1 mt-1"
                            >Design System</span
                          >
                        </div>
                      </div>
                      ...
                      <li class="list-group-item">
                        ...
                        ><a href="#" class="dropdown-item"
                          ><span class="d-flex align-items-center"
                            ...
                            <span>Schedule meetings</span></span
                          ></a
                        >
                      </li>
                      <li class="list-group-item">
                        ...
                        ><a href="#" class="dropdown-item"
                          ...
                          ><span
                            class="avtar avtar-xs rounded-circle bg-danger text-white"
                            >10</span
                          ></a
                        >
                      </li>
                      ...
                      <li class="list-group-item">
                        ...
                        ><a href="#" class="dropdown-item"
                          ><span class="d-flex align-items-center"
                            ...
                            <span
                              class="badge bg-light-success border border-success ms-2"
                              >NEW</span
                            >
                          </span></a
                        ><a href="#" class="dropdown-item"
